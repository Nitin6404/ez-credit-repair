export function Contactform() {
  return (
    <div className="w-full md:w-auto">
      <div className="flex justify-center px-4 py-8 md:mb-[300px] md:ml-[660px] md:mt-[-800px] md:py-0">
        <div className="flex h-auto w-full flex-col bg-[url('/src/components/asset/faqbg.png')] bg-cover bg-center p-4 md:h-[800px] md:w-[533px] md:p-6">
          <div className="mt-0 flex-1 md:mt-[-10px]">
            ...
            <form className="mt-[15px] grid gap-3 md:mt-[25px] md:gap-4">
              ...
              <textarea
                ...
                className="h-[150px] rounded-sm bg-[#496480] p-3 font-montserrat text-[16px] font-[400] leading-[20px] md:h-[150px] md:p-4 md:text-[18px] md:leading-[22px]"
              ></textarea>
