    ...
    <div className="relative p-2 mt-3">
        ...
        <div className="md:w-[300px] mb-4 md:mb-0">
          ...
          <div className="space-y-2">
            <div className="flex items-center p-4 bg-green-500 text-white rounded">
              <span className="bg-white text-green-500 font-bold rounded-sm w-5 h-5 flex items-center justify-center mr-3">
                01
              </span>
              <span>Credit Report Analysis</span>
            </div>
            <div className="flex items-center p-4 bg-green-500 text-white rounded">
              <span className="bg-white text-green-500 font-bold rounded-full w-5 h-5 flex items-center justify-center mr-3">
                02
              </span>
      ...
      <div className="w-[1050px] min-h-[400px] mt-[100px] mb-2 mx-auto flex items-center justify-between p-6 bg-gray-100">
        ...
        <div className="max-w-md">
          <h1 className="text-3xl font-bold mb-4 mr-10">
            Better Credits awaits,
          </h1>
