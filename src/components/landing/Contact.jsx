        ...
        <div className="bg-blue-800 text-white w-full p-6 rounded-lg flex flex-col md:flex-row">
          ...
          <div className="flex-1 md:mr-8 mt-[-20px]">
            ...
            <form className="grid gap-3 mt-[-25px]">
              ...
              <textarea
                ...
                className="p-2 rounded bg-white text-black h-10"
              ></textarea>
              <button className="p-2 rounded bg-green-500 text-white font-bold">
                Sign Up Now
              </button>
            </form>
          </div>
          ...
          <div className="w-[100px] md:w-[40%] mt-[-20px] ">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                <span role="img" aria-label="web" className="mr-2">
                  🌐
                </span>{" "}
                ezecreditrepair.com
              </li>
