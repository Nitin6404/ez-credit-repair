    ...
    <div className="flex w-full flex-col">
      ...
      <div className="mt-20 w-full bg-[#15549A] px-24 py-12 text-start font-inter text-white">
        ...
        <p className="mb-3 text-xl font-normal">
          ...
          American Express, which requires a <b>minimum of 10 days</b>. If the reporting date has
          already passed, the tradeline's first reporting date will shift to the following month.
        </p>
